...
//  fann_test
//
//  Created by language-vm on 2024/7/16.
//
...
/* The Computer Language Benchmarks Game
   ...
   Version: Swift simple program https://benchmarksgame-team.pages.debian.net/benchmarksgame/program/fannkuchredux-swift-1.html
 
   Modified by Anna Skantz
*/
import Foundation

public class FannkuchReduxNative {
    
    public init() {}
    
    private func fannkuch(_ n: Int) -> Int {
...
var fannkuchReduxNative = FannkuchReduxNative();
